...
namespace Number {
    static const vector< int > LETTERS_TO_NUMBERS = {
...
int main( int argc, char ** argv ) {
    ...
    for ( int t = 0; t < T; t++ ) {
        ...
        map< string, int > numbersCountMap;
        ...
        for ( int n = 0; n < numbersCount; n++ ) {
            ...
            for ( int i = 0; i < numStr.size(); i++ ) {
                if ( isdigit( numStr[ i ] ) ) {
                    ...
                    newNumStr += to_string( Number::LETTERS_TO_NUMBERS[ numStr[ i ] - 'A' ] );
                }
            ...
            if ( numbersCountMap.find( newNumStr ) != numbersCountMap.end() ) {
                ++numbersCountMap[ newNumStr ];
                hasDuplicates = true;
            } else {
                numbersCountMap.insert( { newNumStr, 1 } );
            }
        }
        ...
        if ( ! hasDuplicates ) {
            ...
            for ( map< string, int >::iterator iter = numbersCountMap.begin(); iter != numbersCountMap.end(); iter++ ) {
                if ( iter->second > 1 ) {
