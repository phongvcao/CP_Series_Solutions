...
int main( int argc, char ** argv ) {
    ...
    while ( true ) {
        ...
        vector< bool > yearsVec( 10000, true );
        for ( int n = 0; n < N; n++ ) {
            int yearDisplayed = 0;
            int yearFixed = 0;
            int yearBehindFixed = 0;

            cin >> yearDisplayed >> yearFixed >> yearBehindFixed;

            for ( int i = 0; i < yearDisplayed; i++ ) {
                yearsVec[ i ] = false;
            }

            for ( int i = yearDisplayed; i < yearsVec.size(); ++i ) {
                if ( i != yearDisplayed && ( i - yearDisplayed ) % ( yearBehindFixed - yearFixed ) != 0 ) {
                    yearsVec[ i ] = false;
                }
            }
        }
