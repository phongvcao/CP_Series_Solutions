...
int main( int argc, char ** argv ) {
    ...
    for ( int n = 0; n < N; n++ ) {
        ...
        unordered_map< char, double > charsToValuesMap;
        ...
        for ( int i = 0; i < paidCharsCount; i++ ) {
            if ( getline( cin, line ) ) {
                ...
                ss >> c >> value;
                value /= 100.0;
                charsToValuesMap.insert( { c, value } );
            }
        }
        ...
        for ( int i = 0; i < textLinesCount; i++ ) {
            if ( getline( cin, line ) ) {
                for ( int j = 0; j < line.size(); j++ ) {
                    if ( charsToValuesMap.find( line[ j ] ) != charsToValuesMap.end() ) {
                        totalValue += charsToValuesMap[ line[ j ] ];
                    }
                }
            }
        }
