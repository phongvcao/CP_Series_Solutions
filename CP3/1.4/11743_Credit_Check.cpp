...
int main( int argc, char ** argv ) {
    ...
    for ( int n = 0; n < N; n++ ) {
        if ( getline( cin, line ) ) {
            ...
            int unDoubledSum = 0;
            while ( ss >> numPartStr ) {
                for ( int i = 0; i < numPartStr.size(); i++ ) {
                    if ( i % 2 == 1 ) {
                        unDoubledSum += numPartStr[ i ] - '0';
                    } else {
                        doubledStr += to_string( 2 * ( numPartStr[ i ] - '0' ) );
                    }
                }
            }

            for ( int i = 0; i < doubledStr.size(); i++ ) {
                doubledSum += doubledStr[ i ] - '0';
            }
